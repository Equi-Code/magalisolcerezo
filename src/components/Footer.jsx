  ...
  return (
    <>
      ...
      <footer className="relative overflow-hidden" style={{ backgroundColor: "#1E1B17" }}>
        ...
        >
          <p style={{ fontFamily: "'Quicksand', sans-serif", color: "rgba(245,240,234,0.2)", fontSize: "0.72rem", letterSpacing: "0.04em" }}>
            {t.rights}
          </p>
          <div className="flex items-center gap-2">
            <div style={{ width: 16, height: 1, backgroundColor: `${THEME.gold}35` }} />
            <StarDeco />
            <div style={{ width: 16, height: 1, backgroundColor: `${THEME.gold}35` }} />
          </div>
