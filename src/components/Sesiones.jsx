...
//     sub: "Te acompaño estés donde estés. Sesiones personalizadas por videollamada para tu comodidad y bienestar.",
//     features: [
...
//     ],
//     ctaMain: "Reservar mi sesión online",
...
//     sub: "I accompany you wherever you are. Personalized video call sessions for your comfort and wellbeing.",
//     features: [
...
//       { icon: "🔒", label: "Safe and\nconfidential space" },
//     ],
//     ctaMain: "Book my online session",
...
//       stroke={THEME.gold} strokeWidth="0.9" strokeOpacity="0.38" fill="none" />
//   </svg>
// );
...
//       backgroundColor: "rgba(45,41,36,0.5)",
...
//           width: 100, height: 2, borderRadius: "0 0 6px 6px",
//           background: `linear-gradient(to right, transparent, ${THEME.gold}90, transparent)`,
//         }} />

//         {/* Cabecera */}
//         <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1.75rem" }}>
//           <div style={{ width: 24, height: 1, backgroundColor: THEME.gold, opacity: 0.5 }} />
//           <span style={{ fontSize: "1.1rem", color: THEME.gold }}>✦</span>
//           <h3 style={{ fontFamily: FONT.serif, fontSize: "1.6rem", fontStyle: "italic", fontWeight: 400, color: THEME.text, margin: 0 }}>
//             {tx.modalTitle}
//           </h3>
//           <div style={{ flex: 1, height: 1, backgroundColor: THEME.gold, opacity: 0.18 }} />
//         </div>
...
//           style={{
//             width: "100%", padding: "0.85rem 1.1rem", borderRadius: "0.85rem",
...
//           }}
//           onFocus={e => { e.target.style.borderColor = `${THEME.sage}80`; e.target.style.boxShadow = `0 0 0 3px ${THEME.sage}18`; }}
//           onBlur={e => { e.target.style.borderColor = "rgba(201,169,110,0.22)"; e.target.style.boxShadow = "none"; }}
//         />

//         {/* Días */}
//         <p style={{
//           fontFamily: FONT.sans, fontSize: "0.68rem", fontWeight: 600,
//           textTransform: "uppercase", letterSpacing: "0.18em", color: THEME.sage, marginBottom: "0.6rem"
//         }}>
//           {tx.selectDay}
//         </p>
...
//                 textAlign: "left", cursor: "pointer", transition: "all 0.22s ease",
//                 border: sel ? `1px solid rgba(138,158,138,0.45)` : "1px solid transparent",
//                 background: sel ? `linear-gradient(135deg, ${THEME.sage}, #A8B9A8)` : `rgba(138,158,138,0.08)`,
//                 color: sel ? "#FDFCFA" : THEME.textMuted,
//                 boxShadow: sel ? `0 6px 20px rgba(138,158,138,0.28)` : "none",
//                 transform: sel ? "translateY(-1px)" : "none",
//               }}>
//                 <div style={{ display: "flex", flexDirection: "column", gap: "0.1rem" }}>
//                   <span style={{ fontSize: "0.6rem", textTransform: "uppercase", letterSpacing: "0.1em", opacity: 0.65 }}>{tx.available}</span>
...
//                 color: sel ? "#FDFCFA" : THEME.textMuted,
//                 boxShadow: sel ? `0 4px 14px rgba(201,169,110,0.32)` : "none",
//               }}>
//                 {time}
//               </button>
//             );
...
//         <div style={{ height: 1, backgroundColor: THEME.border, marginBottom: "1.25rem" }} />

//         {/* Botón WhatsApp */}
//         <button onClick={handleBook} style={{
//           width: "100%", padding: "0.95rem", borderRadius: "0.85rem", border: "none",
//           display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem",
//           background: THEME.sage, color: "#fff", fontFamily: FONT.sans,
//           fontSize: "0.9rem", fontWeight: 600, letterSpacing: "0.03em",
//           cursor: "pointer", boxShadow: `0 6px 24px rgba(138,158,138,0.35)`, transition: "all 0.25s",
//         }}
//           onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.background = "#9AAF9A"; }}
//           onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.background = THEME.sage; }}
//         >
...
//           {tx.cta}
//         </button>
//         <p style={{ fontFamily: FONT.sans, fontSize: "0.72rem", textAlign: "center", marginTop: "0.6rem", color: THEME.sage, opacity: 0.75 }}>
//           {tx.ctaNote}
//         </p>
...
//           backgroundColor: "transparent", border: "none", color: THEME.textMuted,
//           fontSize: "1.1rem", opacity: 0.4, cursor: "pointer", transition: "opacity 0.2s",
//         }}
...
//         backgroundColor: THEME.bgRose, overflow: "hidden",
//       }}>
//         {/* Decoraciones */}
//         <StarDeco style={{ top: "1.5rem", right: "12%" }} />
//         <StarDeco style={{ bottom: "4rem", left: "6%", width: 14, height: 14 }} />
//         <StarDeco style={{ top: "42%", right: "4%", width: 8, height: 8 }} />
//         <MoonDeco style={{ top: "1.5rem", left: "10%" }} />
//         <MoonDeco style={{ bottom: "2.5rem", right: "8%" }} />

//         {/* Pluma dorada superior derecha */}
//         <img src="/assets/plumas1.png" alt="" aria-hidden="true" style={{
//           position: "absolute", top: "-6%", right: "-4%",
//           width: "clamp(180px, 28vw, 320px)", opacity: 0.5, mixBlendMode: "multiply",
//           transform: "rotate(14deg) scaleX(-1)", objectFit: "contain",
//           pointerEvents: "none", userSelect: "none",
//           filter: "sepia(1) saturate(2.2) hue-rotate(5deg) brightness(0.88)",
//         }} onError={e => { e.target.style.display = "none"; }} />

//         {/* Pluma dorada inferior izquierda */}
//         <img src="/assets/plumas1.png" alt="" aria-hidden="true" style={{
//           position: "absolute", bottom: "-5%", left: "-5%",
//           width: "clamp(140px, 20vw, 220px)", opacity: 0.32, mixBlendMode: "multiply",
//           transform: "rotate(-18deg)", objectFit: "contain",
//           pointerEvents: "none", userSelect: "none",
//           filter: "sepia(1) saturate(2.0) hue-rotate(8deg) brightness(0.9)",
//         }} onError={e => { e.target.style.display = "none"; }} />
...
//                 boxShadow: `0 24px 64px rgba(138,158,138,0.22), 0 6px 20px rgba(201,169,110,0.10)`,
//                 border: `1px solid rgba(201,169,110,0.2)`,
//                 backgroundColor: `rgba(238,243,238,0.6)`, maxWidth: 360, width: "100%",
//               }}>
//                 {/*
//                   ↓ IMAGEN DE LAPTOP — reemplazar src="/assets/sesiones-laptop.jpg"
//                   Puede ser una foto de laptop, cuaderno, velas, cualquier imagen de contexto holístico
//                 */}
//                 <img
//                   src="/public/assets/computadora.jpeg"
//                   alt="Sesiones online — Magalí Sol Cerezo"
//                   style={{
//                     width: "100%",
//                     height: "420px",
//                     display: "block",
...
//                     p.innerHTML += `<div style="text-align:center;padding:2.5rem;color:${THEME.sage}"><div style="font-size:3rem;margin-bottom:0.75rem">💻</div><div style="font-family:'Quicksand',sans-serif;font-size:0.9rem;opacity:0.75;font-style:italic">Sesiones Online</div></div>`;
//                   }}
//                 />
//               </div>
...
//                 backgroundColor: "rgba(253,252,250,0.92)", backdropFilter: "blur(10px)",
//                 border: `1px solid ${THEME.gold}35`, borderRadius: "9999px",
//                 padding: "0.45rem 1.25rem",
//                 boxShadow: `0 6px 20px rgba(201,169,110,0.18)`,
//                 whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 6,
//               }}>
//                 <span style={{ color: THEME.gold, fontSize: "0.7rem" }}>✦</span>
//                 <span style={{
//                   fontFamily: FONT.sans, fontSize: "0.72rem", fontWeight: 600,
//                   color: THEME.sage, letterSpacing: "0.1em", textTransform: "uppercase"
//                 }}>
//                   Sesiones Online
//                 </span>
//               </div>
...
//             {/* Título */}
//             <h2 style={{
//               fontFamily: FONT.serif, fontSize: "clamp(2rem, 4vw, 2.8rem)",
//               fontWeight: 400, fontStyle: "italic", lineHeight: 1.2,
//               color: THEME.text, marginBottom: "0.6rem",
//             }}>
//               {tx.title}
//             </h2>
...
//                 <path d="M8 0L9 6L15 8L9 10L8 16L7 10L1 8L7 6Z" fill={THEME.gold} fillOpacity="0.5" />
//               </svg>
//             </div>

//             {/* Subtítulo */}
//             <p style={{
//               fontFamily: FONT.sans, fontSize: "0.97rem", lineHeight: 1.85,
//               color: THEME.textMuted, marginBottom: "2rem", maxWidth: "44ch",
//             }}>
//               {tx.sub}
//             </p>

//             {/* Features — 4 tarjetitas en fila */}
//             <div style={{
//               display: "grid",
...
//                   padding: "0.7rem 0.35rem", borderRadius: "1rem",
//                   backgroundColor: "rgba(253,252,250,0.75)", backdropFilter: "blur(8px)",
//                   border: `1px solid rgba(232,226,220,0.7)`,
//                   boxShadow: "0 2px 10px rgba(45,41,36,0.04)",
//                   transition: "transform 0.25s, box-shadow 0.25s, border-color 0.25s",
//                   cursor: "default",
//                 }}
//                   onMouseEnter={e => {
//                     e.currentTarget.style.transform = "translateY(-3px)";
//                     e.currentTarget.style.boxShadow = `0 8px 24px rgba(138,158,138,0.14)`;
//                     e.currentTarget.style.borderColor = `${THEME.gold}35`;
//                   }}
//                   onMouseLeave={e => {
//                     e.currentTarget.style.transform = "translateY(0)";
//                     e.currentTarget.style.boxShadow = "0 2px 10px rgba(45,41,36,0.04)";
//                     e.currentTarget.style.borderColor = "rgba(232,226,220,0.7)";
//                   }}
//                 >
//                   <div style={{
//                     width: 42, height: 42, borderRadius: "50%",
//                     backgroundColor: `${THEME.sage}18`, border: `1px solid ${THEME.sage}28`,
//                     display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem",
//                   }}>
//                     {f.icon}
//                   </div>
//                   <span style={{
//                     fontFamily: FONT.sans, fontSize: "0.65rem", fontWeight: 500,
//                     color: THEME.text, lineHeight: 1.45, whiteSpace: "pre-line",
//                   }}>
//                     {f.label}
//                   </span>
//                 </div>
...
//               background: THEME.sage, color: "#fff", fontFamily: FONT.sans,
//               fontSize: "0.92rem", fontWeight: 600, letterSpacing: "0.03em",
//               cursor: "pointer", boxShadow: `0 6px 28px rgba(138,158,138,0.38)`,
//               transition: "all 0.3s ease",
//             }}
//               onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.background = "#9AAF9A"; e.currentTarget.style.boxShadow = `0 12px 36px rgba(138,158,138,0.48)`; }}
//               onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.background = THEME.sage; e.currentTarget.style.boxShadow = `0 6px 28px rgba(138,158,138,0.38)`; }}
//             >
//               {/* Ícono calendario */}
